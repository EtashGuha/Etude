...
public class RLogicalVectorOutType extends RVectorOutType {

	private boolean[] elements = new boolean[0];

	public RLogicalVectorOutType(String expr) {
		super(expr);
	...
	public ROutTypes getType() {
		return ROutTypes.LOGICAL_VECTOR;
	}

	@Override
	public String toString() {
		return "RLogicalVectorOutType [elements=" + Arrays.toString(elements)
	...
	public boolean rGet(RExecutor exec) {
		boolean[] result = exec.evalGetBooleanArray(this
