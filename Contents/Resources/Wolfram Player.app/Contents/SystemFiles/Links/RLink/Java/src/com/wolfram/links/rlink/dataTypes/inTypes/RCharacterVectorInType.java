...
public class RCharacterVectorInType extends RVectorInType {

	private final String[] elements;

	public RCharacterVectorInType(String[] elements,
	...
	public boolean rPut(String rVar, RExecutor exec) {
		return exec.assignStringArray(rVar, this.elements)
