...
public class RNullOutType extends ROutTypeImpl {

	public RNullOutType(String expr) {
		super("NULL");
	...
	public String toString() {
		return "RNullOutType [value=" + this.getVariableNameOrCodeString()
				+ "]";
	}

	@Override
	public ROutTypes getType() {
		return ROutTypes.NULL;
	}
