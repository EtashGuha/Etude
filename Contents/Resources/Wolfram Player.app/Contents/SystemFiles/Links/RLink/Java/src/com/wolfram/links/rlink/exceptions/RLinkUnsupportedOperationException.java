package com.wolfram.links.rlink.exceptions;
...
public class RLinkUnsupportedOperationException extends RLinkException{

	public RLinkUnsupportedOperationException(String message) {
		super(message);		
	}
