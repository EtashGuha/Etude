...
namespace Wolfram.NETLink.Internal
{
    ...
    /// named extMLxxx) for the Linux64 platform by delegating to calls in the native Windows
    /// MathLink library.
    /// </summary>
    /// 
    internal class Unix64MathLinkAPIProvider : IMathLinkAPIProvider
    {
