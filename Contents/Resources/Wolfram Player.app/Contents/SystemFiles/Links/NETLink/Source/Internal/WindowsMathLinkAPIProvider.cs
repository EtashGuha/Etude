...
namespace Wolfram.NETLink.Internal
{
    ...
    /// named extMLxxx) for the Win32 platform by delegating to calls in the native Windows
    /// MathLink library.
    /// </summary>
    /// 
    internal class WindowsMathLinkAPIProvider : IMathLinkAPIProvider
    {
