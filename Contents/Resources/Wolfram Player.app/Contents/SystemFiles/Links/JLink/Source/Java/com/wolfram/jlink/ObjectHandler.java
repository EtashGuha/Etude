...
class InstanceCollection {
	...
	// Since hashCode() comes from the object's "value" -- exactly from its value for Exprs --
	// it is possible to have many objects that have the same hash, hurting the performance of keyOf()
	// if these objects are returned to Mathematica.  Use System.identityHashCode() instead.
