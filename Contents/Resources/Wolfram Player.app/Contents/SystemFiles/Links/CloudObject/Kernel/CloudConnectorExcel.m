...
Options[CloudObject`Private`cloudConnectorExcelForm] = {
...
CloudObject`Private`cloudConnectorExcelForm[evaluation_, opts: OptionsPattern[]] := restructureAndGetDimensions[evaluation, opts]

Options[restructureAndGetDimensions] = Options[CloudObject`Private`cloudConnectorExcelForm];
...
Options[tester] = Options[CloudObject`Private`cloudConnectorExcelForm]
...
Options[format] = Options[CloudObject`Private`cloudConnectorExcelForm];
