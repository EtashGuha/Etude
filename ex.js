...
var question = "What is a whale whale but my apartment is large?"
function keyword(s) {
...
for (var i = textArray.length - 1; i >= 0; i--) {
    ...
    clessq.forEach((item) => {
    	...
    	sumOfMatches += stringSimilarity.findBestMatch(item, noMatchList).bestMatch.rating
    })
    var rating = sharedSize * 2.0 / (question.size + currSentence.size) + sumOfMatches/clessq.size
    console.log(rating)
