(function(exports) {
  ...
  exports.loadDocument = function(docurl) {
    return PDFNet.runGeneratorWithoutCleanup(initAll(docurl), window.parent.sampleL); // replace with your own license key and remove the license-key.js script tag
  };
