...
([
	...
	(function(module, exports, __webpack_require__) {
		...
		function webViewerFindFromUrlHash(evt) {
			...
			bestMatchRatings = []
			correspondingMatchIdx = []
			correspondingMatchLength = []
			arrOfMatchesWithLength = []
		...
		var PDFFindController =
			...
			function() {
				...
				_createClass(PDFFindController, [{
					...
					key: "executeCommandWithCallback",
					value: function executeCommandWithCallback(cmd, state, callback) {
						var _this = this;
