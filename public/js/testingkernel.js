...
async function getAnswer(question, text, realAnswer){
	...
	for (var i = textArray.length - 1; i >= 0; i--) {
		...
		if(stringSimilarity.compareTwoStrings(item, realAnswer) > .9) {
			console.log("Real Answer: " + item)
...
async function runTests(filepath) {
	...
	for(var object in obj.data) {
		...
		var answer = await getAnswer(object.question, text, realAnswer)
		var bestMatch = stringSimilarity.findBestMatch(object.answer, answer).bestMatch
		if(bestMatch.rating < .9) {
			console.log("FAILURE")
			console.log("Question: " + object.question)
			console.log("Real Answer: " + object.answer)
